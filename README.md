...
step 0: Have ffmpeg installed. I always think this is installed by default. 

If it ain't: 

```sudo apt install ffmpeg``` 

I hope whatever version your distros repository gives you works. If you're on windows. Use WSL debian idk.
